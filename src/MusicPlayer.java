...
public class MusicPlayer extends PlaybackListener {
    ...
    public void setPlaylistPanel(JPanel playlistPanel) {
    ...
    public void addSongToPlaylist(File songFile){
        Song song = new Song(songFile.getAbsolutePath());
        playlist.add(song);
        updatePlaylistPanel();
    }

    public void updatePlaylistPanel(JPanel playlistPanel){
        this.playlistPanel = playlistPanel;
        updatePlaylistPanel();
    }
}